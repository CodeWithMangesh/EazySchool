package com.easybytes.easyschool.configuration;
...
public class ProjectSecurityConfig {
	...
	SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		.requestMatchers("/admin/allRequests/**").hasRole("ADMIN")
		.requestMatchers("/eazyschool/actuator/**").hasRole("ADMIN")
		.requestMatchers("/api/**").authenticated()
		.requestMatchers("/","/home").permitAll()
		.requestMatchers("/displayProfile").authenticated()
		.requestMatchers("/student/**").hasRole("STUDENT")
		.requestMatchers("/student/enrollCourses").hasRole("STUDENT")
	...
	//below code is for hardcoded users
	/*
	@Bean
